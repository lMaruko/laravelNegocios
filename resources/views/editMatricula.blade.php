    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-8">
                ...
                <H1 style="padding-top: 10px">Editar Matrícula</H1>
                <div style="padding-bottom: 30px">
                    @foreach ($datos as $dato)
                        <form method="POST" action="{{ route('matriculas.update', [$dato->idmatricula]) }}">
                            @method("PUT")
                            @csrf
                            <div class="mb-3">
                                <label for="" class="form-label">ID Matrícula</label>
                                <input type="text" class="form-control" id="disabledInput"
                                    value="{{ $dato->idmatricula }}" disabled>
                            </div>
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="" name="idseccion" class="form-control" id=""
                                    value="{{ $dato->idseccion }}">
                            </div>
                            <button type="submit" class="btn btn-primary">Modificar</button>
                            <a type="submit" class="btn btn-danger"
                                href="{{ route('matriculas.index') }}">Cancelar</a>
                        </form>
                    @endforeach
                </div>
