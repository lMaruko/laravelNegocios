    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-8">
                ...
                <H1 style="padding-top: 10px">Editar Estudiante</H1>
                <div style="padding-bottom: 30px">
                    @foreach ($datos as $dato)
                        <form method="POST" action="{{ route('estudiantes.update', [$dato->idestudiante]) }}">
                            @method("PUT")
                            @csrf
                            <div class="mb-3">
                                <label for="" class="form-label">ID Estudiante</label>
                                <input type="text" class="form-control" id="disabledInput"
                                    value="{{ $dato->idestudiante }}" disabled>
                            </div>
                            <div class="mb-3">
